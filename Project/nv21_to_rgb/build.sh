...
g++ -o run.out $1 $gladsrc $stb_src -I$gl_include_dir -L$assimp_lib_dir -L$glfw3_lib_dir -lassimp -lglfw3 -lGL -lX11 -lpthread -lXrandr -lXxf86vm -lXinerama -lXcursor -lXi -ldl -g
